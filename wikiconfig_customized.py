...
class Config(multiconfig.DefaultConfig):
    ...
    sitename = u"Clement's Wiki"

    # Wiki logo. You can use an image, text or both. [Unicode]
    # For no logo or text, use '' - the default is to show the sitename.
    # See also url_prefix setting below!
    logo_string = u'<img src="%s/common/moinmoin.png" alt="Moinmoin">' % url_prefix_static
    ...
    superuser = [u"clement", ]
    acl_rights_default = u'clement:read,write,delete,revert,admin All:read'
